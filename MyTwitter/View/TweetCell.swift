...
class TweetCell: DatasourceCell {
    ...
    let replyButton: UIButton = {
        ...
        button.setImage(#imageLiteral(resourceName:"arrowshape.turn.up.left.fill").withRenderingMode(.alwaysOriginal), for: .normal)
        return button
    }()
    
    let retweetButton: UIButton = {
        let button = UIButton(type: .system)
        button.setImage(#imageLiteral(resourceName:"arrow.triangle.2.circlepath").withRenderingMode(.alwaysOriginal), for: .normal)
        return button
    }()
    
    let likeButton: UIButton = {
        let button = UIButton(type: .system)
        button.setImage(#imageLiteral(resourceName:"hand.thumbsup.fill").withRenderingMode(.alwaysOriginal), for: .normal)
        return button
    }()
    
    let directMessageButton: UIButton = {
        let button = UIButton(type: .system)
        button.setImage(#imageLiteral(resourceName:"message.fill").withRenderingMode(.alwaysOriginal), for: .normal)
        return button
    }()
